...
class Tile(object):
    ...
    def to_TEM(self, downscaled_id):
        ...
        xarray.Dataset
            ...
            precipitation
        '''
        if downscaled_id == 'co2':
            self.logger.info("Converting CO2 data to TEM format...")
            ...
            return xr.Dataset(data_vars={'co2':('year',co2)}, coords={'year':year})



        # For any of the others, make sure it exists...
